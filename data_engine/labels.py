...
sport = ['skating', 'golf', 'canoeing', 'dance', 'water sports', 'fitness', 'badminton', 'gymnastics', 'softplay', 'abseiling', 'pitch and putt', 'basketball', 'basket ball', 'cycling', 'coached activities', 'aerobic', 'fencing', 'tennis', 'coaching', 'orienteering', 'hockey', 'croquet', 'powerboat', 'swim', 'cricket', 'gym', 'football', 'hillwalking', 'table tennis', 'dinghy cruising', 'bouldering', 'american football', 'climbing', 'bmx', 'short tennis', 'athletics', 'turkish baths', 'judo', 'sailing', 'racing', 'aquafit', 'kayaking', 'skateboard', 'rugby', 'volleyball', 'aerial assault ', 'squash', 'bowling', 'biking', 'bike', 'bowling']

brave = ['skating', 'canoeing', 'abseiling', 'fencing', 'orienteering', 'hockey', 'powerboat', 'hillwalking', 'bouldering', 'american football', 'climbing', 'bmx', 'judo', 'sailing', 'racing', 'kayaking', 'skateboard', 'rugby', 'aerial assault ', 'biking', 'bike', 'judo', 'water sports', 'powerboat', 'hillwalking', 'dinghy cruising', 'bouldering', 'american football', 'climbing', 'bmx', 'sailing', 'racing', 'kayaking', 'skateboard', 'rugby', 'biking', 'bike', 'orienteering']

travel = ['hill', 'castle', 'clock', 'tower', 'brae', 'canoeing', 'cycling', 'orienteering', 'boat', 'cruising', 'hiking', 'climbing', 'bike', 'biking', 'kayaking']

friendly = ['community', 'centre', 'dance', 'softplay', 'pitch and putt', 'coached activities', 'table tennis', 'short tennis', 'turkish baths', 'volleyball', 'basket ball', 'basketball', 'golf', 'badminton', 'tennis', 'croquet', 'bowling']

exploration = ['castle', 'statue', 'memorial', 'gate', 'stone', 'fountain', 'clock', 'brae', 'doocot', 'arch', 'pillar', 'monument', 'war', 'piers']

nature = ['park', 'garden', 'hill', 'lake', 'district', 'meadows', 'golf', 'canoeing', 'kayaking', 'hillwaking', 'climbing', 'sailing']
